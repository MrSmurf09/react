  ...
  return (
    <div className={Styles.principal}>
      ...
      <div className={Styles.contenido}>
        ...
        <div className={Styles.contenido_column}>
          ...
          <button><Link to="/Vivy" className={Styles.link}>Ir a ver</Link></button>
        </div>
      </div>
    </section>
    <aside>
    <div className={Styles.nuevos_articulos}>
      ...
      <ul>
        ...
        <li>
        <Link to="Toji" className={Styles.link}>Toji vs Gojo</Link>
