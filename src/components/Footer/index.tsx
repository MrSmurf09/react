    ...
    <footer>
      <div className={Styles.articulos_footer}>
        <div className={Styles.articulo}>
          <Link to="/Gojo"><img  src="https://i.postimg.cc/3N7zDPCT/sukuna-vs-gojo-manga-panel.jpg" alt="" /></Link>
        ...
        <div className={Styles.articulo}>
        <Link to="/Sukuna"><img  src="https://i.postimg.cc/hjtQSqP0/sukuna-vs-mahoraga.jpg" alt="" /></Link>
        ...
        <div className={Styles.articulo}>
        <Link to="Toji"><img  src="https://i.postimg.cc/X7QhJf8c/gojovuela.png" alt="" /></Link>
          <h3>Toji vs Gojo</h3>
